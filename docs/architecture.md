...
- One remaining Flutter feature screen — Staff — still a permission-gated placeholder in the navigation shell; POS, Tables management, Kitchen/KDS, Billing, and Reports (all above) are done.
