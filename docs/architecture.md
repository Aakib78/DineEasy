...
- Every remaining Flutter feature screen — Tables (floor/table *management*, beyond what the POS's read-only table picker covers), Kitchen/KDS, Billing, Reports, Staff — still permission-gated placeholders in the navigation shell; POS (above) is the first one done.
