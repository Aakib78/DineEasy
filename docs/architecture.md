...
- Every remaining Flutter feature screen — Billing, Reports, Staff — still permission-gated placeholders in the navigation shell; POS, Tables management, and Kitchen/KDS (all above) are done.
