...
- Every actual Flutter feature screen (POS, tables, KDS, billing, reports, staff) — today they're permission-gated placeholders in the navigation shell described above.
- Notifications module.
- `packages/shared_types`, `apps/customer_web` — directories exist, contents don't yet.
