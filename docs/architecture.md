...
- Every remaining Flutter feature screen — Reports, Staff — still permission-gated placeholders in the navigation shell; POS, Tables management, Kitchen/KDS, and Billing (all above) are done.
